-- 1. Add commission_percentage to courses (default 50% for backward compatibility)
ALTER TABLE courses ADD COLUMN IF NOT EXISTS commission_percentage INTEGER DEFAULT 50;

-- 2. Add receive_general_commission to profiles (default false)
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS receive_general_commission BOOLEAN DEFAULT FALSE;

-- 3. Update the Commission Calculation Logic
